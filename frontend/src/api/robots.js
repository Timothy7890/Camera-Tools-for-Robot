...
export async function fetchCalibrationFileJson(unitCode, id, name) {
  return request(`/api/robots/units/${encodeURIComponent(unitCode)}/calibrations/${id}/files/${encodeURIComponent(name)}`)
}
